        ...
        <div className='container mx-auto px-4'>
          <div className='flex items-center	justify-between	'>
            ...
            <button onClick={toggleTheme} id="theme-toggle" type="button" className="text-gray-500 text-sm p-2.5 rounded-lg bg-white">
                <svg id="theme-toggle-dark-icon" className="hidden w-5 h-5" fillRule="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg>
